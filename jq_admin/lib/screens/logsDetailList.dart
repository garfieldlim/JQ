...
class LogDetailsPageList extends StatelessWidget {
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: key == 'milvusData' &&
                            ...
                            ? _buildMilvusDataCell(context, value)
                            : Text(
                                value,
                                style: const TextStyle(
                                  color: Color(
  ...
  Widget _buildMilvusDataCell(BuildContext context, String value) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
          value.substring(0, 50), // Show the first 50 characters
          style: const TextStyle(
            color: Color(0xff797979), // Change text color here
          ),
        ),
        TextButton(
          ...
          child: const Text(
            'See More',
            style: TextStyle(
              color: Color(0xfff2c87e), // Change button text color here
            ),
          ),
        ),
      ],
